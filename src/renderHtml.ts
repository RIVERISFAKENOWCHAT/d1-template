      ...
      <body>
        ...
        <script>
          ...
          const TOWERS = [
            ...
            { id: "flame", name: "Flamethrower", cost: 150, damage: 1.5, atkSpeed: 0.1, range: 6, color: "#d90429", shape: "ellipse", burn: true },
          ...
          function updateTowers() {
            for (const tower of state.towers) {
              ...
              if (!target) continue;
              tower.cooldown = Math.max(1, Math.round(tower.model.atkSpeed * 60));
